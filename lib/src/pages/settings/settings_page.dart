...
class _SettingsPageViewState extends State<_SettingsPageView> {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                _buildPinboardSettingsSection(context, state),

                const SizedBox(height: 32),

                // AI Assistance Section
                _buildAiSettingsSection(context, state),
              ],
            ),
          ),
        );
  ...
  Widget _buildPinboardSettingsSection(
  ...
  Widget _buildAiSettingsSection(BuildContext context, SettingsState state) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('AI Assistance', style: MacosTheme.of(context).typography.title1),
        const SizedBox(height: 12),
        ...
        if (state.isAiEnabled) ...[
          ...
          Row(
            children: [
              PushButton(
                controlSize: ControlSize.large,
                onPressed: () => context.read<SettingsCubit>().saveOpenAiKey(),
              ...
              PushButton(
                controlSize: ControlSize.large,
                secondary: true,
                onPressed: () => context.read<SettingsCubit>().clearOpenAiKey(),
                child: const Text('Clear'),
              ),
            ],
          ),
          ...
          ValidatedSecretField(
            ...
            helperText: 'Leave empty for free tier, or enter your Jina API key',
          ...
          PushButton(
            controlSize: ControlSize.large,
            secondary: true,
            onPressed: () => context.read<SettingsCubit>().clearAllAiSettings(),
