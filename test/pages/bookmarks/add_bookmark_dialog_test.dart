...
void main() {
  ...
  Widget createTestWidget() {
    return MacosApp(
      home: MacosWindow(child: Builder(builder: (context) => AddBookmarkDialog())),
    );
  }

  testWidgets('AI completion button is enabled when valid URL is loaded from clipboard', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('AI completion button is disabled when AI settings are disabled', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('AI completion button is disabled when URL is invalid', (WidgetTester tester) async {
    when(mockAiSettingsService.isEnabled).thenReturn(true);
    when(mockOpenAiSettings.hasApiKey).thenReturn(true);
